...
Процедура ДобавитьКомандыСозданияНаОсновании(КомандыСозданияНаОсновании, Параметры) Экспорт
	...
	Документы.алкЗаказАкцизныхМарок.ДобавитьКомандуСоздатьНаОсновании(КомандыСозданияНаОсновании);
	//>РАП: алкКТ2000Алкоголь КТ-2000
...
Функция ТекстЗапросаТаблицаЗаказыПоставщикам(Запрос, ТекстыЗапроса, Регистры, ДокументОбъект = Неопределено)
	...
	//<< Портал-Юг, Кондрашихин, 2024.03.27 [Обновление ERP 2.5] // Описание: 
	// заказы со статусом Согласован тоже должны проходить по регистру как подтвержденные. Жизненный цикл заказа пользователи меняют другим нетиповым реквизитом
	
	|  ЗНАЧЕНИЕ(Перечисление.СтатусыЗаказовПоставщикам.Согласован),
	
	//<< Портал-Юг, Кондрашихин, 2024.03.27
...
Процедура ОтразитьРаспределениеЗапасовДвижения(Запрос, ТекстыЗапроса, Регистры)
	...
	ТекстЗапросаТабЧасть =
		...
		// Если ПЛ_ОтменитьРаспределениеЗапасов = Истина, движения в регистры запасов не формируем 
		// есть множество заказов, которые технически закрыть невозможно
		|	И НЕ ТабЧасть.Ссылка.ПЛ_ОтменитьРаспределениеЗапасов
...
Функция ПолучитьДанныеДляПечатнойФормыЗаказаНаТоварыУслуги(МассивОбъектов, ПараметрыПечати, КодЯзыка = Неопределено) Экспорт
	...
	Возврат ПЛ_Сервер.IT_ПолучитьДанныеДляПечатнойФормыЗаказаНаТоварыУслуги(МассивОбъектов, ПараметрыПечати);
